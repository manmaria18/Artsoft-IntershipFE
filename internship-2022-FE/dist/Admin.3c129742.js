...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/FrontPage.js":[function(require,module,exports) {
"use strict";
...
var _ReloadTable = _interopRequireDefault(require("./ReloadTable"));
...
var FrontPage = /*#__PURE__*/function () {
  function FrontPage(element) {
    ...
    _defineProperty(this, "contactForm", {
      firstName: '',
      lastName: '',
      phoneNumber: '',
      status: ''
    ...
    _defineProperty(this, "contactFormList", new Array());

    _defineProperty(this, "table", new _ReloadTable.default(document.getElementById('table')));

    this.element = element;
    this.handleChange = this.handleChange.bind(this);
    this.handleSubmit = this.handleSubmit.bind(this); //this.reloadTable  = this.reloadTable.bind(this);
  ...
  _createClass(FrontPage, [{
    ...
    key: "bindTableValuesToModalInputs",
    value: function () {
      var _bindTableValuesToModalInputs = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
        var _this = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 9;
                return fetch('http://localhost:3000/calls/' + e.target.dataset.callId, {
                  method: 'GET'
                    ...
                    return _regeneratorRuntime().wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          ...
                          case 2:
                            _this.contactForm = _context.sent;
                            console.log(_this.contactForm);
                            document.getElementById('currentId').value = _this.contactForm.id;
                            document.getElementById('firstName2').value = _this.contactForm.firstName;
                            document.getElementById('lastName2').value = _this.contactForm.lastName;
                            document.getElementById('phoneNumber2').value = _this.contactForm.phoneNumber;
                            document.getElementById('status2').value = _this.contactForm.status;
      ...
      function bindTableValuesToModalInputs(_x) {
        return _bindTableValuesToModalInputs.apply(this, arguments);
      }

      return bindTableValuesToModalInputs;
    }()
  }, {
    key: "handleUpdate",
    value: function () {
      var _handleUpdate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
        var _this2 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                //this.reloadTable();
                console.log('UPDATE'); //console.log(e.target);
                //console.log(e.target.dataset.callId);
                //document.getElementById('currentId').value="";
                ...
                if (errors == "" || errors == null) {
                  ...
                  fetch('http://localhost:3000/calls/' + this.contactForm.id, {
                    ...
                    _this2.table.reloadTable(); //this.bindTableValuesToModalInputs();
    ...
    key: "handleSubmit",
    value: function () {
      var _handleSubmit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(_event) {
        var _this3 = this;
              ...
              case 0:
                ...
                if (errors == "" || errors == null) {
                  ...
                  fetch('http://localhost:3000/calls', {
                    ...
                    _this3.table.reloadTable(); //this.registerEvents();
    ...
    key: "handleDelete",
    value: function () {
      var _handleDelete = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(e) {
        var _this4 = this;
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 4;
                return fetch('http://localhost:3000/calls/' + e.target.id, {
                  method: 'DELETE'
                }).then( /*#__PURE__*/function () {
                  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(resp) {
                    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                      while (1) {
                        switch (_context5.prev = _context5.next) {
                          ...
                          case 2:
                            _this4.contactForm = _context5.sent;
                            console.log(_this4.contactForm);

                            _this4.table.reloadTable();
    ...
    value: function registerEvents() {
      console.log('register'); //this.table.reloadTable();
      ...
      var erasers = new Array();
      erasers = document.querySelectorAll('.delete-button');

      for (var _i = 0; _i < erasers.length; _i++) {
        erasers[_i].addEventListener('click', this.handleDelete);
      ...
      document.querySelector('.edit-button').addEventListener('click', this.handleUpdate); //document.querySelector('table').addEventListener('click',this.reloadTable);
    }
  }]);
...
},{"./ReloadTable":"scripts/ReloadTable.js"}],"scripts/ReloadTable.js":[function(require,module,exports) {
"use strict";
...
var _FrontPage = _interopRequireDefault(require("./FrontPage"));
...
var ReloadTable = /*#__PURE__*/function () {
  function ReloadTable(element) {
    _classCallCheck(this, ReloadTable);

    this.element = element; //this.bindTableValuesToModalInputs = this.bindTableValuesToModalInputs.bind(this);
  }

  _createClass(ReloadTable, [{
    key: "reloadTable",
    value: function () {
      var _reloadTable = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(table) {
        var response, thead, tbody, new_table, row, heading_0, heading_1, heading_2, heading_3, heading_4, heading_5, heading_6, value, i, new_row, new_row_count, new_row_fname, new_row_lname, new_row_phone, new_row_status, new_row_pencil, new_button, currentId, new_row_eraser, new_button_2, frontPage;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch('http://localhost:3000/calls', {
                  method: 'GET'
                });

              case 2:
                response = _context.sent;
                console.log('reload'); //console.log(table);
                //new_table.setAttribute("id","table");
                //new_table.setAttribute("class","table table-striped table-bordered table-primary");

                thead = document.createElement('thead');
                tbody = document.createElement('tbody'); // table = document.querySelector('.table table-striped table-bordered table-primary');

                new_table = document.getElementById('table'); //new_table=table;

                new_table.innerHTML = '';
                new_table.appendChild(thead);
                new_table.appendChild(tbody);
                row = document.createElement('tr');
                heading_0 = document.createElement('th');
                heading_0.innerHTML = "#";
                ...
                heading_4 = document.createElement('th');
                heading_4.innerHTML = "Status";
                heading_5 = document.createElement('th');
                heading_5.innerHTML = "Update";
                heading_6 = document.createElement('th');
              ...
              case 35:
                this.contactFormList = _context.sent;
                table = new_table;
                value = 50;
                document.getElementById('body').appendChild(table);

                for (i = 0; i < this.contactFormList.length; i++) {
                  this.contactForm = this.contactFormList[i];
                  new_row = document.createElement('tr');
                  new_row_count = document.createElement('td');
                  new_row_count.innerHTML = this.contactForm.id;
                  new_row_fname = document.createElement('td');
                  new_row_fname.innerHTML = this.contactForm.firstName;
                  new_row_lname = document.createElement('td');
                  new_row_lname.innerHTML = this.contactForm.lastName;
                  new_row_phone = document.createElement('td');
                  new_row_phone.innerHTML = this.contactForm.phoneNumber;
                  new_row_status = document.createElement('td');
                  new_row_status.innerHTML = this.contactForm.status;
                  new_row_pencil = document.createElement('td');
                  new_button = document.createElement('button'); //new_button.setAttribute("id","modalPencil");

                  currentId = this.contactForm.id;
                  new_button.setAttribute("type", "button"); //new_button.setAttribute("id", "edit-" + currentId);
                  ...
                  new_button.setAttribute("data-bs-target", "#exampleModal2"); //new_button.setAttribute("onclick","this.bindTableValuesToModalInputs()");
                  ...
                  new_row_eraser = document.createElement('td');
                  new_button_2 = document.createElement('button');
                  new_button_2.setAttribute("id", "" + currentId);
                  new_button_2.setAttribute("type", "button");
                  new_button_2.setAttribute("class", "btn btn-primary delete-button"); //new_button_2.setAttribute("data-bs-target","#"+currentId);
                  ...
                  tbody.appendChild(new_row); //console.log('created');
                } // .then(() => {
                //   // console.log(resp);
                // });
                ...
                frontPage = new _FrontPage.default(document.getElementById('modalButton'));
...
var _default = ReloadTable;
exports.default = _default;
},{"./FrontPage":"scripts/FrontPage.js"}],"../node_modules/@popperjs/core/lib/enums.js":[function(require,module,exports) {
"use strict";
...
},{"@popperjs/core":"../node_modules/@popperjs/core/lib/index.js"}],"scripts/Admin.js":[function(require,module,exports) {
"use strict";
...
new _bootstrap.Modal(modalNode);
var table = document.getElementById('table');
console.log(table);
var promise = new Promise(function (resolve, reject) {
  resolve();
});
promise.then( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var new_table;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          new_table = new _ReloadTable.default(document.getElementById('table'));
          _context.next = 3;
          return new_table.reloadTable();
  ...
  var frontPage = new _FrontPage.default(document.getElementById('modalButton'));
  frontPage.registerEvents();
...
},{"./ReloadTable":"scripts/ReloadTable.js","./FrontPage":"scripts/FrontPage.js","bootstrap":"../node_modules/bootstrap/dist/js/bootstrap.esm.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/Admin.js"], null)
//# sourceMappingURL=/Admin.3c129742.js.map